...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    {
        /// <summary>
        /// Determines whether this symbol has the concept attribute set.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Determines whether this symbol represents a concept.
        /// </summary>
        /// <returns>
        ...
        {
            return (this.MergedDeclaration.Kind == DeclarationKind.Concept ||
                    (this.IsInterfaceType() && this.HasConceptAttribute()));
        }

        /// <summary>
        /// Determines whether this symbol has the instance attribute set.
        /// </summary>
        /// <returns>
        ...
        {
            return (this.MergedDeclaration.Kind == DeclarationKind.Instance ||
